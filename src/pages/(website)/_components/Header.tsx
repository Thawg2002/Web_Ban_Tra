                    ...
                    <div className="">
                        <Link to={""}>
                            <img
                                ...
                                alt=""
                                className="w-[117px] h-[30px] md:w-[150px] md:h-[40px] lg:w-[80px] lg:h-[140px]"
                            />
                        </Link>
                    </div>
                    {/* menu */}
                    <div className="hidden lg:flex  items-center ml-4">
                        <ul className="flex lg:text-[14px] xl:text-[16px] font-semibold cursor-pointer">
                            <Link to={""}>
                ...
                <ul className="p-4 flex flex-col space-y-4 font-semibold text-[16px] cursor-pointer">
                    ...
                    <Link to={""} className="flex justify-between">
                        <li>
                            ...
                            {menuMoblie ? (
                                <ul className="text-[13px]  cursor-pointer ml-2 *:mt-5">
                                    ...
                                    <li>
                                        <Link to={"/qua-tang"}>QUÀ TẶNG</Link>
                                    </li>
                                </ul>
                            ) : (
                                ""
                        ...
                        <div>
                            {menuMoblie ? (
                                <AiFillCaretUp
                                    onClick={() => setMenuMoblie(!menuMoblie)}
                                />
                            ) : (
                                <AiFillCaretDown
                                    onClick={() => setMenuMoblie(!menuMoblie)}
